          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <Select name="season" value={formData.season} onValueChange={(value) => handleSelectChange('season', value)}>
                ...
                <SelectContent>
                  <SelectItem value="spring" className="text-sm sm:text-base">Spring</SelectItem>
                  <SelectItem value="summer" className="text-sm sm:text-base">Summer</SelectItem>
                  <SelectItem value="autumn" className="text-sm sm:text-base">Autumn</SelectItem>
                  <SelectItem value="winter" className="text-sm sm:text-base">Winter</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
